...
COLLISION_ROW = (
    ...
    (61, "Statewide_Vehicle_Type_At_Fault", DataType.TEXT, None, convert, None),
...
PARTY_ROW = (
    ...
    (26, "Statewide_Vehicle_Type", DataType.TEXT, None, convert, None),
...
VICTIM_ROW = (
    ...
    (3, "Victim_Sex", DataType.TEXT, None, convert, None),
    (4, "Victim_Age", DataType.INTEGER, ["998"], convert, None),
    (5, "Victim_Degree_Of_Injury", DataType.TEXT, None, convert, None),
