...
COLLISION_ROW = (
    ...
    (55, "pedestrian_collision", DataType.INTEGER, DEFAULT_NULLS, string_to_bool, None),
    (56, "bicycle_collision", DataType.INTEGER, DEFAULT_NULLS, string_to_bool, None),
    (57, "motorcycle_collision", DataType.INTEGER, DEFAULT_NULLS, string_to_bool, None),
    (58, "truck_collision", DataType.INTEGER, DEFAULT_NULLS, string_to_bool, None),
...
PARTY_ROW = (
    ...
    (6, "party_sobriety", DataType.TEXT, DEFAULT_NULLS, convert, None),
    ...
    (13, "cellphone_use", DataType.TEXT, DEFAULT_NULLS, convert, None),
